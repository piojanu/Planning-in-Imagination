...
***** DONE =max_steps: 10000000, free_nats: 5, divergence_scale: 7E-03= on DGX
      Noisy as hell and score gets lower with more steps.
***** DONE =max_steps: 10000000, free_nats: 3, divergence_scale: 3E-02= on DGX
      Blurry as hell.
***** WAITING =max_steps: 10000000, free_nats: 3, divergence_scale: 8E-03= on DGX
**** IN-PROGRESS Boxing:
***** DONE =max_steps: 10000000, batch_shape: [20, 50], free_nats: 12, divergence_scale: 3E-02= on DES16 :success:
      Boxing started working! Score ~30 after 6.5M steps.
***** TODO =max_steps: 10000000, batch_shape: [20, 50], free_nats: 3, divergence_scale: 3E-02= on DES16
**** IN-PROGRESS MsPacman:
***** TODO =max_steps: 10000000, batch_shape: [20, 50], free_nats: 3, divergence_scale: 3E-02= on DES17
