...
*** IN-PROGRESS Try to set =free_nats= to a larger value and divergence scale to a lower value.
...
***** WAITING Random search: =max_steps: 1000000, free_nats: [2, 20], divergence_scale: [10, [-4, -1]]=
**** IN-PROGRESS MsPacman
***** WAITING Random search: =max_steps: 2000000, free_nats: [2, 10], divergence_scale: [10, [-4, -1]]=
**** TODO Crazy Climber
***** DONE =free_nats: 3=
...
*** IN-PROGRESS Run training for longer with best parameters to see if rewards will start to converge.
**** IN-PROGRESS Freeway:
