...
\caption[World Models probabilistic graphical model]{World Models probabilistic graphical model: solid arrows describe the predictive model, dotted arrow describes the inference model \editnote{NOTE: It needs to be explained in Theoretical Background what is the difference.}, stochastic nodes are circles and squares depict deterministic nodes.}
...
\editnote{TODO: Add neural net architectures in here.}
