...
\editnote{TODO: Add ES planner description AND the algorithm.}
...
\editnote{TODO: Add the detailed search algorithm description here e.g. a paragraph about a backup phase modification to take into account rewards along the path.}
