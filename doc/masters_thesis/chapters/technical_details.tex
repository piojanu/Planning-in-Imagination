...
The implementation of Sokoban used for those experiments procedurally generates a new level each episode. This means an agent cannot memorize specific puzzles. Together with the planning aspect, this makes for a very challenging environment. While the underlying game logic operates in a 10 × 10 grid world, with 7 possible elements in each grid (see Table.~\ref{Table.Sokoban_elements}), agents were trained directly on RGB sprite graphics. Fig.~\ref{Fig.Sokoban} shows an example of Sokoban level with 4 boxes. \\
...
\begin{tabular}{| c | c | c |} 
\hline
\textbf{Type} & \textbf{State} & \textbf{Graphic} \\
\hline
Wall & Static & \parbox[c]{2em}{\includegraphics[]{figures/Sokoban/wall.png}} \\
\hline
Floor & Empty & \parbox[c]{2em}{\includegraphics[]{figures/Sokoban/floor.png}} \\
\hline
Box target & Empty & \parbox[c]{2em}{\includegraphics[]{figures/Sokoban/box_target.png}} \\
\hline
Box & Off target & \parbox[c]{2em}{\includegraphics[]{figures/Sokoban/box.png}} \\
\hline
Box & On target & \parbox[c]{2em}{\includegraphics[]{figures/Sokoban/box_on_target.png}} \\
\hline
Player & Off target & \parbox[c]{2em}{\includegraphics[]{figures/Sokoban/player.png}} \\
\hline
Player & On target & \parbox[c]{2em}{\includegraphics[]{figures/Sokoban/player_on_target.png}} \\
\hline
\end{tabular}
\caption[Sokoban elements]{Sokoban possible elements in each grid, also referred to as blocks.}
\label{Table.Sokoban_elements}
\end{table}
