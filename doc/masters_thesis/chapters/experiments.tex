...
In two experiments below ideas from previous section were put into the test: an easier environment and iterative data collection. First, original World Models is trained for the Boxing environment. Then, World Models is coupled with AlphaZero planner and both are trained jointly, iteratively collecting data.
...
Fig.~\ref{Fig.PlaNet_Boxing_lower_divergence_scale} shows final result.
